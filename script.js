...
function bindEvents() {
  ...
  document.querySelectorAll(".nav-item").forEach((button) => button.addEventListener("click", () => {
    ...
    document.querySelector("#pageTitle").textContent = { calendar: "Monthly Content Calendar", qc: "Quality Control", special: "Special Days Calendar", overview: "Brand Overview", links: "Content Links", usecase: "Use Case Diagram", sop: "Brand Brief", settings: "Settings" }[button.dataset.view];
  }));
  ...
  document.querySelector("#otherResourcesBtn")?.addEventListener("click", openOtherResources);
