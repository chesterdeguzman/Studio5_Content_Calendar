...
let remote = { brands: {}, targets: DEFAULT_TARGETS, calendar: {}, specialDays: {}, assetRequests: {}, brandResources: {}, brandBibles: {}, brandMaterials: {}, studioResources: {}, sopResources: {}, contentLinks: {} };
...
function bindEvents() {
  ...
  document.querySelectorAll(".nav-item").forEach((button) => button.addEventListener("click", () => {
    ...
    document.querySelector("#pageTitle").textContent = { calendar: "Monthly Content Calendar", qc: "Quality Control", special: "Special Days Calendar", overview: "Brand Overview", links: "Content Links", usecase: "Use Case Diagram", sop: "Brand Brief", resources: "Other Resources", settings: "Settings" }[button.dataset.view];
  }));
