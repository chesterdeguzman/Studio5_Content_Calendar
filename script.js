...
let remote = { brands: {}, targets: DEFAULT_TARGETS, calendar: {}, specialDays: {}, assetRequests: {}, brandResources: {} };
...
function bindEvents() {
  ...
  document.querySelectorAll(".nav-item").forEach((button) => button.addEventListener("click", () => {
    ...
    document.querySelector("#pageTitle").textContent = { calendar: "Monthly Content Calendar", special: "Special Days Calendar", overview: "Brand Overview", usecase: "Use Case Diagram", settings: "Settings" }[button.dataset.view];
  }));
...
function buildExportHtml() {
  ...
  return `<!doctype html><html><head><meta charset="utf-8"><style>
    body{font-family:Arial,sans-serif;color:#171412;margin:38px;font-size:10.5pt;line-height:1.45}h1{font-size:24pt;margin:0 0 4px}h2{font-size:12pt;color:#95161b;margin:0 0 24px;text-transform:uppercase;letter-spacing:.08em}.meta{border-top:3px solid #c52026;border-bottom:1px solid #ddd;padding:10px 0;margin-bottom:20px}.meta strong{display:inline-block;min-width:80px}.asset-box{background:#fff8e5;border-left:5px solid #e4b82e;padding:12px 14px;margin:16px 0 22px}.asset-box p{margin:6px 0 0}table{width:100%;border-collapse:collapse}th{background:#111;color:#fff;text-align:left;padding:8px 7px;font-size:8.5pt}td{border-bottom:1px solid #ddd;padding:8px 7px;vertical-align:top}.focus{margin-top:4px;color:#655;font-size:9pt}.footer{margin-top:26px;padding-top:10px;border-top:1px solid #ddd;color:#777;font-size:8.5pt}</style></head><body>
